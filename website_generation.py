...
from perfume_recommender.perfume_recommender.data_processing.data_processing import DataProcessor
from perfume_recommender.perfume_recommender.perfume_recommendation.perfume_recommendation import PerfumeRecommender
from perfume_recommender.perfume_recommender.text_generation.text_generation import TextGenerator
...
def main():
    ...
    try:
        ...
        processor = DataProcessor(
            "perfume_recommender/data/fra_cleaned.csv", 
            "perfume_recommender/data/extracted_reviews_with_perfume_names.csv"
        )
